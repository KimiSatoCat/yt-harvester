...
const TRANSLATIONS = {
  ja: {
    ...
    must_placeholder: '例: 自動運転',
    any_label: 'いずれか（OR）— | または半角スペース区切り',
    any_placeholder: '例: 事故|危険|問題',
    not_label: '除外（NOT）— 半角スペース区切り',
    not_placeholder: '例: ゲーム フィクション',
    related_terms: '関連語提案:',
  ...
  en: {
    ...
    must_placeholder: 'e.g. self-driving',
    any_label: 'Any of these (OR) — separate with | or space',
    any_placeholder: 'e.g. accident|danger|problem',
    not_label: 'Exclude (NOT) — space separated',
    not_placeholder: 'e.g. game fiction',
    ...
    lang_both: 'Japanese & English (separate output files)',
